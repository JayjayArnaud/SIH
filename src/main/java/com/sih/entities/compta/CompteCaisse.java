...
import com.sih.entities.stoc.Caisse;
...
public class CompteCaisse {
	...
	public CompteCaisse(Long idAffectComptCai, Date datDebAffComptCai, Date datFinAffComptCai, Compte compte,
			Caisse caisse) {
		super();
	...
	public String element() {
		return idAffectComptCai + "; " + datDebAffComptCai
				+ "; " + datFinAffComptCai + "; " + compte + "; " + caisse ;
	}
